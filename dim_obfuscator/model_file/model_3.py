...
import math
# (CIFAR format) A simple two-layer CNN to test obfuscating convolution dimension parameters
class custom_cnn_3(torch.nn.Module):
    def __init__(self, input_features, reshape = True, widen_list = None, decompo_list = None, dummy_list = None, deepen_list = None, skipcon_list = None, kerneladd_list = None):
        super(custom_cnn_3,self).__init__()
        ...
        self.conv_bn1 = torch.nn.BatchNorm2d(128)
...
model = custom_cnn_3(input_features).to(cuda_device)
