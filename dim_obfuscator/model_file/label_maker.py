...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', default='./model_4.npy')
    parser.add_argument('--model_id', default=4, type=int, help='Which Model You Want to Make the Label for? Name the ID')
    parser.add_argument('--input_string', default="111")
    ...
    make_label_from_string(args.model_id-1, args.input_string)