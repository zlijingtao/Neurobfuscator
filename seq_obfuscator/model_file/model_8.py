...
class custom_cnn_7(torch.nn.Module):
    def __init__(self, input_features, reshape = True, widen_list = None, decompo_list = None, dummy_list = None, deepen_list = None, skipcon_list = None, kerneladd_list = None):
        ...
        self.conv7 = torch.nn.Conv2d(16, 16, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn7 = torch.nn.BatchNorm2d(16)
        self.conv8 = torch.nn.Conv2d(16, 16, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn8 = torch.nn.BatchNorm2d(16)

        self.conv9 = torch.nn.Conv2d(16, 16, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn9 = torch.nn.BatchNorm2d(16)
        self.conv10 = torch.nn.Conv2d(16, 16, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn10 = torch.nn.BatchNorm2d(16)


        self.conv11 = torch.nn.Conv2d(16, 32, (3, 3), stride=(2, 2), padding=(1, 1))
        ...
        self.conv13 = torch.nn.Conv2d(16, 32, (1, 1), stride=(2, 2), padding=(0, 0))
        self.conv_bn13 = torch.nn.BatchNorm2d(32)

        self.conv14 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn14 = torch.nn.BatchNorm2d(32)
        self.conv15 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn15 = torch.nn.BatchNorm2d(32)

        self.conv16 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn16 = torch.nn.BatchNorm2d(32)
        self.conv17 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn17 = torch.nn.BatchNorm2d(32)

        self.conv18 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn18 = torch.nn.BatchNorm2d(32)
        self.conv19 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn19 = torch.nn.BatchNorm2d(32)

        self.conv20 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn20 = torch.nn.BatchNorm2d(32)
        self.conv21 = torch.nn.Conv2d(32, 32, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn21 = torch.nn.BatchNorm2d(32)





        self.conv22 = torch.nn.Conv2d(32, 64, (3, 3), stride=(2, 2), padding=(1, 1))
        self.conv_bn22 = torch.nn.BatchNorm2d(64)
        self.conv23 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn23 = torch.nn.BatchNorm2d(64)
        self.conv24 = torch.nn.Conv2d(32, 64, (1, 1), stride=(2, 2), padding=(0, 0))
        self.conv_bn24 = torch.nn.BatchNorm2d(64)

        self.conv25 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn25 = torch.nn.BatchNorm2d(64)
        self.conv26 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn26 = torch.nn.BatchNorm2d(64)

        self.conv27 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn27 = torch.nn.BatchNorm2d(64)
        self.conv28 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn28 = torch.nn.BatchNorm2d(64)

        self.conv29 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn29 = torch.nn.BatchNorm2d(64)
        self.conv30 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn30 = torch.nn.BatchNorm2d(64)

        self.conv31 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn31 = torch.nn.BatchNorm2d(64)
        self.conv32 = torch.nn.Conv2d(64, 64, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_bn32 = torch.nn.BatchNorm2d(64)
