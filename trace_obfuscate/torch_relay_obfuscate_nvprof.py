...
import pandas as pd
import importlib
from torch_relay_build_nvprof import torch_relay_func
from torch_func_modifier import func_modifier
from torch_utils import setup_logger, summary
sys.path.append('../train_predictor')
from torch_utils import setup_logger, summary, get_extra_entries, identify_model, modify_state_dict, csv_to_time_overhead
...
def main():
    ...
    parser.add_argument('--out_name', type=str, default="nvprof", help='lib_name=lib_${model_name}_${out_name}')
    ...
    parser.add_argument('--non_fuse', action='store_true', default=True, help='Do not fuse')
    ...
    predictor_name = "{}_{}".format(args.predictor_name, num_hidden)
    ...
    torch_relay_func(args, False, args.autotvm_on)
    ...
    # try:
    #     cost = csv_to_time_overhead(sample_file)
    # except:
    ...
    #     log_dir = "../train_predictor/obfuscator/predictor/logs_{}".format(predictor_name)
    # elif predict_type == "full":
    #     log_dir = "../train_predictor/obfuscator/predictor/logs_full_{}".format(predictor_name)
    # elif predict_type == "time_only":
    #     log_dir = "../train_predictor/obfuscator/predictor/logs_timeonly_{}".format(predictor_name)
    ...
    # print("Prediction after obfuscation is", predict)
