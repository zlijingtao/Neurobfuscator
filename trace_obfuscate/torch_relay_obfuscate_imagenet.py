...
def main():
    ...
    parser.add_argument('--model_id', type=int, default=9, help='model_id, 0 ~ 2')
    parser.add_argument('--batch_size', type=int, default=1, help='input batch size.')
    parser.add_argument('--input_features', type=int, default=150528, help='flattened input dimension.')
    ...
    parser.add_argument('--num_hidden', type=int, default=512, help='number of hidden units for the LSTM')
    parser.add_argument('--predictor_name', type=str, default='deepsniffer_LSTM_both_autotvm_smart_imagenet')
    ...
    predictor_name = "{}_{}_PL".format(args.predictor_name, num_hidden)
    ...
    sample_file = "./env_file/lib_model_{}_obf_0.csv".format(model_id+1)
