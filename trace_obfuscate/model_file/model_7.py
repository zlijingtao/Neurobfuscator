...
#This model stands for vgg-13
#model_id = 6 (regardless of the file name)

# 11: [64, 'M', 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],
# 13: [64, 64, 'M', 128, 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M'],

class custom_cnn_6(torch.nn.Module):
    def __init__(self, input_features, reshape = True, widen_list = None, decompo_list = None, dummy_list = None, deepen_list = None, skipcon_list = None, kerneladd_list = None):
        super(custom_cnn_6,self).__init__()
        ...
        self.conv6 = torch.nn.Conv2d(256, 512, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv7 = torch.nn.Conv2d(512, 512, (3, 3), stride=(1, 1), padding=(1, 1))
        self.conv8 = torch.nn.Conv2d(512, 512, (3, 3), stride=(1, 1), padding=(1, 1))
...
model = custom_cnn_6(input_features).to(cuda_device)
