...
def main():
    ...
    gen_label = True
    # not_contain_depth = True
    if gen_label:
        mstring_path = "./trace/complex_batch_{}_nclass_{}_infeat_{}_seed_{}.mstring".format(args.batch_size, args.num_classes, args.input_features, args.random_seed)
    ...
    #     not_contain_depth = False
    # for test only
    # model_name = 'cnn_256p3p1p1p0_128p3p1p1p1_16p3p1p1p0_res16p1_depth256p1_64p3p1p1p0_1024p3p1p1p0_bn0_mlp_256_128_256_64_bn0'
